    ...
    <section className="about-container">
      <div className="about-top">
        <div className="about-text">
          <h2>About Us</h2>
          <p>
            Phoenix Femmes Pvt.Ltd. ia a transformative platform dedicated to empowering individuals through a unique fusion of 
            entrepreneurship training, softskills development, and mental wellness practices.
          </p>
          <p><strong>Empowering Minds, Elevating Lives : Phoenix Femmes ignites transformation through entrepreneurship, soft skills, and wellness!!</strong></p>
