...
const SoftSkills = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/enroll-softskills', data);
  ...
  return (
    <div className="soft-skills-container">
      ...
      <section>
        ...
        <p>(Auto-updated from backend CMS or Google Calendar integration)</p>
      ...
      <section>
        ...
        <p>For questions: support@phoenixfemmes.com | +91-XXXXXXXXXX</p>
      ...
      <footer>
        ...
        <form>
          <label htmlFor="newsletter">Stay inspired. Get updates:</label>
